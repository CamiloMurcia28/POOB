...
public class Canvas{
    ...
    public void setForegroundColor(String colorString){
        if(colorString.equals("red"))
            ...
            graphic.setColor(new Color(255,0,0,128));
        else if(colorString.equals("light black"))              
            graphic.setColor(new Color(0,0,0,128));
        else if(colorString.equals("light blue"))            
            graphic.setColor(new Color(0,0,255,128));
        else if(colorString.equals("light yellow"))              
            graphic.setColor(new Color(255,255,0,128));
        else if(colorString.equals("light green"))              
            graphic.setColor(new Color(0,255,0,128));
        else if(colorString.equals("light magenta"))              
            graphic.setColor(new Color(255,0,255,128));
        else if(colorString.equals("light white"))
            graphic.setColor(new Color(255, 255, 255, 128));
         else if(colorString.equals("light cyan"))
            graphic.setColor(new Color(0, 255, 255, 128));
        else if(colorString.equals("light orange"))
            graphic.setColor(new Color(255, 165, 0, 128));
        else if(colorString.equals("light gray"))
            graphic.setColor(new Color(128,128, 128, 128));
        else if(colorString.equals("light pink"))
            graphic.setColor(new Color(255, 192, 203, 128));
        else
            graphic.setColor(Color.black);
    }
