...
/**
 * Clase para IceePeeCee Contest resuelve el problema de la maraton
...
public class IceepeeceeContest {
    ...
    public float solve(int[][][] islands, int[][][] flights){
        this.iceepeecee = new Iceepeecee(islands, flights);
        int cantidadIslas = iceepeecee.islands().length;
        float angulo= binarySearch(cantidadIslas, iceepeecee);
        return angulo;
    }
    ...
    public void simulate(int[][][] islands, int[][][] flights) {
        ...
        for(int contador = 0; contador < (int)(res);contador++){
            iceepeecee.photograph((float)(contador));
