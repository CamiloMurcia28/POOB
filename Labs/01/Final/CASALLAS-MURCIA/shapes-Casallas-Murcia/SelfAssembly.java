...
public class SelfAssembly
{
    ...
    /**
     *gives an initial value to the cells of the board
     *@param give the position in rows
     *@param give the position in columns
     */
    ...
    /**
     * Tells us what value the specified position has
     * @param give the position in rows
     * @param give the position in columns
     */
    ...
    /**
     * Ejecution of the Replicate method
     * Si tiene mas de 3 vecinos, se muere por sobrepob
     * Si tiene menos de 2 se muere, si tiene exactamente 2 se multiplica
     */
    ...
    /*
     * Change the value of the position to cero
     */
    ...
    /*
     * Change the value of the position to 1
     */
    ...
    /*
     * Create the board with hexagons
     * @param give the position in columns
     * @param give the position in rows
     */
